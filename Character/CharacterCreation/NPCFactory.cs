public static class NPCFactory
{
    ...
    public static NPC GenerateGoblin(eEnemyType enemyType ,ConsoleColor selfColor,int intelligence)
    {
        NPC character = null;
        switch(enemyType)
        {   //Generates a Goblin Shaman
            case eEnemyType.Supportive:
                ...
                ICombatBrain brain = new NPCOffensiveAI(); //EDIT CHANGE TO SUPPORTIVE AI CHANGED FOR TESTING PURPOSES
                ...
                //Creates the NPC
                character = new("Goblin Shaman",50,5,10,brain,intelligence,selfColor);
            ...
            case eEnemyType.Caster:
                ...
                // Creates the NPC
                character = new NPC("Goblin Pyromancer", 45, 4, 12, brain, intelligence,selfColor);
            ...
            case eEnemyType.Bruiser:
                ...
                // Creates the NPC
                character = new NPC("Goblin Berserker", 60, 8, 10, brain,  intelligence,selfColor); // Adjusted stats for a tankier DPS
                ...
                case eEnemyType.Minion:
                    ...
                    switch(randomNumber.Next(0,3))
                    {
                        case 0:
                            ...
                            character = new NPC("Goblin Grunt",25,5,1,brain,0,selfColor); // Adjusted stats for a tankier DPS
                        ...
                        case 1:
                            ...
                            character = new NPC("Goblin Archer",20,5,1,brain,0,selfColor); // Adjusted stats for a tankier DPS
                        ...
                        case 2:
                            ...
                            character = new NPC("Goblin Archer",15,7,1,brain,0,selfColor); // Adjusted stats for a tankier DPS
                            character.Abilities.Add(magicBolt);
                            break;
                    }
                    break;
                case eEnemyType.Boss:
                    brain = new GoblinNecromancerBrain();
                    character = new NPC("Goblin Necromancer",200,35,0,brain,0,selfColor);
                    //Phase 1 spells
                    ...
                    character.AbilityListDictionary[0] = new List<Ability>()
                    {
                        summonGoblin,
                        shadowyWard,
                    ...
                    character.Abilities = character.AbilityListDictionary[0];
                    //Phase 2 spells
                    //Phase 3 spells
